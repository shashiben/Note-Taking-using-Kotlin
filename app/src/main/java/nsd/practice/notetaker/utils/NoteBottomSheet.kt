package nsd.practice.notetaker.utils
...
import kotlinx.android.synthetic.main.notes_bottom_sheet.*
...
class NoteBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        val view = LayoutInflater.from(context)?.inflate(R.layout.notes_bottom_sheet, null)
        if (view != null) {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.notes_bottom_sheet, container, false)
    }
